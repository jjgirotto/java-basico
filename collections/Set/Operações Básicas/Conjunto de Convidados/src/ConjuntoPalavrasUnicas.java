...
public class ConjuntoPalavrasUnicas {
    ...
    public static void main(String[] args) {
        ...
        conjuntoPalavras.adicionarPalavra("Livro");
        conjuntoPalavras.adicionarPalavra("Mesa");
        conjuntoPalavras.adicionarPalavra("Cadeira");
        conjuntoPalavras.adicionarPalavra("Cama");

        conjuntoPalavras.exibirPalavrasUnicas();

        conjuntoPalavras.removerPalavra("Cama");
        conjuntoPalavras.exibirPalavrasUnicas();

        System.out.println(conjuntoPalavras.verificarPalavra("Livro"));
    }
}
